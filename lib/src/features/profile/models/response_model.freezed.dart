...
class _$ResponseModelImpl implements _ResponseModel {
  const _$ResponseModelImpl({required this.responseMessage});
  ...
  @override
  String toString() {
    return 'ResponseModel(responseMessage: $responseMessage)';
  }
...
abstract class _ResponseModel implements ResponseModel {
  const factory _ResponseModel({required final String responseMessage}) =
      _$ResponseModelImpl;
