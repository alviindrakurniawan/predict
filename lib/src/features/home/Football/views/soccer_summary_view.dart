...
class SoccerSummaryView extends HookConsumerWidget {
  final String matchId;

  SoccerSummaryView({required this.matchId});

  static const String routeName = '/soccer-summary';
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                color: isSelected.value == "summary"
                                    ? primaryColor
                                    : Colors.white,
                  ...
                  //submenu content
                  _buildSwitchContent(context, isSelected.value, fixture),
