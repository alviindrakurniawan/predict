...
class ForgetPasswordOtpView extends HookConsumerWidget {
  const ForgetPasswordOtpView({required this.email});
  final String  email ;
  ...
  Future<void> _inputOTP(BuildContext context, WidgetRef ref,{required String otp}) async {
    try {
      ...
      if (context.mounted) {
        if (result['data'] != null ) {
          ...
          context.push(CreateNewPasswordView.routeName,extra: email);
        } else {
  ...
  Future<void> _forgetpass(BuildContext context, WidgetRef ref) async {
    try {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('You’ve got mail 📩', style: context.headlineLarge),
                    SizedBox(
                      height: 12,
                    ),
                    Text(
                ...
                child: CustomGreenFilledButton(
                    onPressed: () {
                      if(formKey.currentState!.validate()){
                        _inputOTP(context, ref,otp: pinController.text);
                      }
